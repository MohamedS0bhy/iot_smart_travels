...
Route::middleware(['auth','admin'])->group(function () {
        ...
        Route::get('/delete-airline/{id}','AirlineController@delete');
        Route::resource('trips', 'TripController');
        Route::get('/delete-trip/{id}','TripController@delete');
        Route::post('/edit-trip/{id}','TripController@edit');
        Route::post('/update-trip/{id}','TripController@update');
